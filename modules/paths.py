...
- TRAINING_SET: Path to the training set file. It is downloaded from the Hugging Face Hub.
- VALIDATION_SET: Path to the validation set file. It is downloaded from the Hugging Face Hub.
...
ONLINE_DATASET_DIR: Path = Path('hf://datasets/sapienzanlp/nlp2025_hw1_cultural_dataset')
TRAIN_SET: Path = ONLINE_DATASET_DIR / 'train.csv'
VALIDATION_SET: Path = ONLINE_DATASET_DIR / 'valid.csv'
